...
VALUES
    (1,100001,'抽奖策略','2024-5-01 09:37:19','2024-5-01 09:37:19');
...
VALUES
    (1,100001,101,'随机积分',NULL,80000,80000,80.0000,'rule_random,rule_luck_award',1,'2024-5-09 09:38:31','2024-5-09 10:58:06'),
    (2,100001,102,'5次使用',NULL,10000,10000,10.0000,'rule_luck_award',2,'2024-5-09 09:39:18','2024-5-09 10:34:23'),
    (3,100001,103,'10次使用',NULL,5000,5000,5.0000,'rule_luck_award',3,'2024-5-09 09:42:36','2024-5-09 10:34:24'),
    (4,100001,104,'20次使用',NULL,4000,4000,4.0000,'rule_luck_award',4,'2024-5-09 09:43:15','2024-5-09 10:34:25'),
    (5,100001,105,'增加gpt-4对话模型',NULL,600,600,0.6000,'rule_luck_award',5,'2024-5-09 09:43:47','2024-5-09 10:34:26'),
    (6,100001,106,'增加dall-e-2画图模型',NULL,200,200,0.2000,'rule_luck_award',6,'2024-5-09 09:44:20','2024-5-09 10:34:26'),
    (7,100001,107,'增加dall-e-3画图模型','抽奖1次后解锁',200,200,0.2000,'rule_lock,rule_luck_award',7,'2024-5-09 09:45:38','2024-5-09 10:30:59'),
    (8,100001,108,'增加100次使用','抽奖2次后解锁',199,199,0.1999,'rule_lock,rule_luck_award',8,'2024-5-09 09:46:02','2024-5-09 12:20:52'),
    (9,100001,109,'解锁全部模型','抽奖6次后解锁',1,1,0.0001,'rule_lock,rule_luck_award',9,'2024-5-09 09:46:39','2024-5-09 12:20:50');
...
VALUES
    (1,100001,101,2,'rule_random','1,1000','随机积分策略','2023-5-09 10:05:30','2023-5-09 12:55:52'),
    (2,100001,107,2,'rule_lock','1','抽奖1次后解锁','2023-12-09 10:16:41','2023-5-09 5:55:53'),
    (3,100001,108,2,'rule_lock','2','抽奖2次后解锁','2023-12-09 10:17:43','2023-5-09 12:55:54'),
    (4,100001,109,2,'rule_lock','6','抽奖6次后解锁','2023-12-09 10:17:43','2023-5-09 12:55:54'),
